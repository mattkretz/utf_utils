...
//--------------
//
ptrdiff_t Convert32_KewbApi(string const& src, size_t reps, u32string& dst,
...
TestAllConversions32(string const& fname, bool isFile, size_t repShift, bool tblCmp)
{
    ...
    else
    {
        ...
        auto&& add = [&](char const* name, TestFn32 fn) {
          times.push_back(TestOneConversion32(fn, u8src, reps, u32answer, name));
          algos.emplace_back(name);
        };
        add("kewb-vir-simd", [](auto a, auto b, auto c) {
          return Convert32_KewbApi(a, b, c, UtfUtils::SimdConvert<UtfUtils::LikeKewb, UtfUtils::BigTable>);
        });
        add("kewb-vir-simd-smart", [](auto a, auto b, auto c) {
          return Convert32_KewbApi(a, b, c, UtfUtils::SimdConvert<UtfUtils::UseNonAsciiKnowledge, UtfUtils::BigTable>);
        });
        add("kewb-vir-simd-all", [](auto a, auto b, auto c) {
          return Convert32_KewbApi(a, b, c, UtfUtils::SimdConvert<UtfUtils::LikeKewbButVecAll, UtfUtils::BigTable>);
        });
        add("kewb-vir-simd-all-smart", [](auto a, auto b, auto c) {
          return Convert32_KewbApi(a, b, c, UtfUtils::SimdConvert<UtfUtils::UseNonAsciiKnowledgeVecAll, UtfUtils::BigTable>);
        });
        //add("vir1", [](auto a, auto b, auto c) { return Convert32_KewbApi(a, b, c, UtfUtils::VirConvert<1>); });
        add("vir2", [](auto a, auto b, auto c) { return Convert32_KewbApi(a, b, c, UtfUtils::VirConvert<2>); });
        add("vir3", [](auto a, auto b, auto c) { return Convert32_KewbApi(a, b, c, UtfUtils::VirConvert<3>); });
        add("vir4", [](auto a, auto b, auto c) { return Convert32_KewbApi(a, b, c, UtfUtils::VirConvert<4>); });
        add("vir2p", [](auto a, auto b, auto c) { return Convert32_KewbApi(a, b, c, UtfUtils::VirConvert<2, true>); });
        add("vir3p", [](auto a, auto b, auto c) { return Convert32_KewbApi(a, b, c, UtfUtils::VirConvert<3, true>); });
        add("vir4p", [](auto a, auto b, auto c) { return Convert32_KewbApi(a, b, c, UtfUtils::VirConvert<4, true>); });
    }
